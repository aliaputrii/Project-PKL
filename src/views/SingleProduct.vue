<template>
  <section class="py-10 sm:py-16">
                      ...
                      <div class="lg:flex lg:items-start">
                          <div class="lg:order-2 lg:ml-5">
                              <div class="max-w-xl overflow-hidden rounded-lg">
                                  <img class="h-full w-full max-w-full object-cover" src="https://media.istockphoto.com/id/467652436/id/foto/buah-buahan-campuran-segar.jpg?s=612x612&w=0&k=20&c=F6jIhF7hBBYD6GLMesgmOolFm6etkbR4WsyWybuYkaA=" alt="" />
                              </div>
                          </div>
                          ...
                          <div class="mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0">
                              <div class="flex flex-row items-start lg:flex-col">
                                  <button type="button"
                                      ...
                                      <img class="h-full w-full object-cover" src="https://media.istockphoto.com/id/467652436/id/foto/buah-buahan-campuran-segar.jpg?s=612x612&w=0&k=20&c=F6jIhF7hBBYD6GLMesgmOolFm6etkbR4WsyWybuYkaA=" alt="" />
                                  </button>
                                  <button type="button"
                  ...
                  <div class="lg:col-span-2 lg:row-span-2 lg:row-end-2">
                      ...
                      <div class="class= grid md:grid-cols-3 mb-3 mt-3">
                            <div class="flex items-center border-gray-100">
                                <!-- Counter Item -->
                                <span @click="kurang"
                                    class="cursor-pointer text-white rounded-l bg-green-500 py-1 px-3.5 duration-100 hover:bg-green-500 hover:text-yellow-50">
    ...
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M1 1h16"/>
                                ...
                                <span @click="tambah"
                                    class="cursor-pointer text-white rounded-r bg-green-500 py-1 px-3 duration-100 hover:bg-green-500 hover:text-yellow-50">
    ...
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 1v16M1 9h16"/>
                      ...
                      <div class="mt-10 flex flex-col items-center justify-between space-y-4 border-t border-b py-4 sm:flex-row sm:space-y-0">
                          ...
                          <button type="button" @click="addToCart(product.id)"
                              ...
                              class="inline-flex items-center justify-center rounded-md border-2 border-transparent bg-green-600 bg-none px-12 py-3 text-center text-base font-bold text-white transition-all duration-200 ease-in-out focus:shadow hover:bg-green-400">
