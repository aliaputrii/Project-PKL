    ...
    <div class="grid grid-cols-4 text-gray-800 lg:grid-cols-3">
      <div class="col-span-4 bg-gray-50 px-8 py-10 text-gray-800 md:col-span-2 md:border-r md:px-10 md:py-12 lg:col-span-1">
        ...
        <ul>
          <li class="mb-6 flex items-start text-left">
            ...
            <div>
              <a class="cursor-pointer font-serif text-base md:text-lg" href="#">aliapokka@gmail.com</a>
          ...
          <li class="my-6 flex items-center text-left">
            ...
            <div>
              <a class="cursor-pointer font-serif text-base md:text-lg" href="#">aliaputrii</a>
          ...
          <li class="my-6 flex items-center text-left">
            ...
            <div>
              <p class="font-serif text-base md:text-lg">alia</p>
      ...
      <div class="order-first col-span-4 max-w-screen-md px-8 py-10 md:order-last md:col-span-2 md:px-10 md:py-12">
        ...
        <form action="">
          ...
          <button type="submit" class="group flex cursor-pointer items-center rounded-xl bg-green-600 bg-none px-8 py-4 text-center font-semibold leading-tight text-white">
            Send
