      ...
      <div class="bg-white shadow">
        <div class="px-4 py-6 sm:px-8 sm:py-10">
          <div class="flow-root">
            <ul class="-my-8">
              ...
              <li v-for="cart in getCart" :key="cart.cart_id" class="flex flex-col space-y-3 py-6 text-left sm:flex-row sm:space-x-5 sm:space-y-0">
                <div class="shrink-0">
                  <img class="h-24 w-24 max-w-full rounded-lg object-cover" src="https://media.istockphoto.com/id/467652436/id/foto/buah-buahan-campuran-segar.jpg?s=612x612&w=0&k=20&c=F6jIhF7hBBYD6GLMesgmOolFm6etkbR4WsyWybuYkaA="  alt="" />
                </div>
                    ...
                    <div class="mt-4 flex items-end justify-between sm:mt-0 sm:items-start sm:justify-end">
                      ...
                      <div class="sm:order-1">
                        <div class="mx-auto flex h-8 items-stretch text-gray-600">
                          <button class="flex items-center justify-center rounded-l-md bg-gray-200 px-4 transition hover:bg-green-600 hover:text-white" @click="changeQty({cartId: cart.cart_id, typeQty: 'minus'})">-</button>
                          <div class="flex w-full items-center justify-center bg-gray-100 px-4 text-xs uppercase transition">{{ cart.qty }}</div>
                          <button class="flex items-center justify-center rounded-r-md bg-gray-200 px-4 transition hover:bg-green-600 hover:text-white" @click="changeQty({cartId: cart.cart_id, typeQty: 'plus'})">+</button>
                        </div>
          ...
          <div class="mt-6 text-center">
            <a href="/checkout">
            <button type="button" class="group inline-flex w-full items-center justify-center rounded-md bg-green-600 px-6 py-4 text-lg font-semibold text-white transition-all duration-200 ease-in-out focus:shadow hover:bg-green-400">
              Checkout
