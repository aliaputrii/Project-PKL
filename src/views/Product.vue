...
<div>
  ...
  <div v-for="product in getLatestProducts.data" :key="product.id" class="relative m-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
    ...
    <img class="object-cover ml-6" src="https://media.istockphoto.com/id/467652436/id/foto/buah-buahan-campuran-segar.jpg?s=612x612&w=0&k=20&c=F6jIhF7hBBYD6GLMesgmOolFm6etkbR4WsyWybuYkaA=" alt="product image" />
    <span class="absolute top-0 left-0 m-2 rounded-full bg-gradient-to-r from-green-400 to-green-700 px-2 text-center text-sm font-medium text-white">50% OFF</span>
  </a>
    </router-link>
  <div class="mt-4 px-5 pb-5">
    ...
    <button type="button" @click="addToCart(product.id)" class="flex items-center justify-center rounded-md bg-green-600 px-20 py-2.5 text-center text-sm font-medium text-white hover:bg-green-600 focus:outline-none focus:ring-4 focus:ring-green-300">
