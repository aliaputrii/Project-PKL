  ...
  <div class="mt-4 py-2 text-xs sm:mt-0 sm:ml-auto sm:text-base">
    <div class="relative">
      <ul class="relative flex w-full items-center justify-between space-x-2 sm:space-x-4">
        ...
        <li class="flex items-center space-x-3 text-left sm:space-x-4">
          <a class="flex h-6 w-6 items-center justify-center rounded-full bg-green-500 text-xs font-semibold text-white ring ring-green-500 ring-offset-2" href="#">2</a>
        ...
        <li class="flex items-center space-x-3 text-left sm:space-x-4">
          <a class="flex h-6 w-6 items-center justify-center rounded-full bg-green-200 text-xs font-semibold text-white" href="#">3</a>
...
<div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
  <div class="px-4 pt-8">
    ...
    <div class="mt-8 flex-1 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
      ...
      <div v-for="checkout in getCart" :key="checkout.cart_id" class="flex flex-col rounded-lg bg-white sm:flex-row">
        <img class="m-2 h-24 w-28 rounded-md border object-cover object-center" src="https://media.istockphoto.com/id/467652436/id/foto/buah-buahan-campuran-segar.jpg?s=612x612&w=0&k=20&c=F6jIhF7hBBYD6GLMesgmOolFm6etkbR4WsyWybuYkaA=" alt="" />
    ...
    <form class="mt-5 grid gap-6">
      <div class="relative">
        ...
        <label class="peer-checked:border-2 peer-checked:border-green-700 peer-checked:bg-green-50 flex cursor-pointer select-none rounded-lg border border-green-300 p-4" for="radio_payment_1">
      ...
      <div class="relative">
        ...
        <span class="peer-checked:border-green-700 absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-green-300 bg-white"></span>
        <label class="peer-checked:border-2 peer-checked:border-green-700 peer-checked:bg-green-50 flex cursor-pointer select-none rounded-lg border border-green-300 p-4" for="radio_payment_2">
    ...
    <form class="mt-5 grid gap-6">
       <div class="relative">
        ...
        <label class="peer-checked:border-2 peer-checked:border-green-700 peer-checked:bg-green-50 flex cursor-pointer select-none rounded-lg border border-green-300 p-4" for="radio_2">
          <img class="w-14 object-contain" src="https://w7.pngwing.com/pngs/776/836/png-transparent-jalur-nugraha-ekakurir-logistics-jne-cepu-jne-wangon-service-others-blue-text-trademark-thumbnail.png" alt="" />
          <div class="ml-5">
            <span class="mt-2 font-semibold">JNE</span>
            <p class="text-slate-500 text-sm leading-6">Delivery: 3-7 Days</p>
            <p class="text-slate-500 text-sm leading-6">Rp.9.0000</p>
          </div>
        </label>
      </div>
      <div class="relative">
        ...
        <label class="peer-checked:border-2 peer-checked:border-green-700 peer-checked:bg-green-50 flex cursor-pointer select-none rounded-lg border border-green-300 p-4" for="radio_1">
          <img class="w-14 object-contain" src="https://www.nuwori.com/wp-content/uploads/2017/10/logo-sicepat.png" alt="" />
          <div class="ml-5">
            <span class="mt-2 font-semibold">SICEPAT Express</span>
            <p class="text-slate-500 text-sm leading-6">Delivery: 2-4 Days</p>
            <p class="text-slate-500 text-sm leading-6">Rp.11.0000</p>
          </div>
        </label>
      </div>
      </form>
  ...
  <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
    ...
    <div class="">
      ...
      <div class="flex flex-col sm:flex-row">
        <div class="relative flex-shrink-0 sm:w-7/12">
          ...
          <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
            <img class="h-4 w-4 object-contain" src="https://img.freepik.com/premium-vector/indonesia-flag_561158-1876.jpg" alt="" />
          </div>
        </div>
    ...
    <button @click="performCheckout" class="mt-4 mb-8 w-full rounded-md bg-green-500 transation duration-700 hover:scale-105 hover:bg-green-500 px-6 py-3 font-medium text-white">Order</button>
  </div>
</div>
